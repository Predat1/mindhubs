          ...
          <div className="prose prose-sm md:prose-base max-w-none space-y-8 text-muted-foreground">
            <AnimateOnScroll>
              <section>
                ...
                <p>Les présentes conditions générales de vente (CGV) régissent l'ensemble des transactions effectuées sur le site Mind Hub. En passant commande, le client accepte sans réserve les présentes CGV. Mind Hub se réserve le droit de modifier ces conditions à tout moment. Les CGV applicables sont celles en vigueur au moment de la commande.</p>
              </section>
            </AnimateOnScroll>
            ...
            <AnimateOnScroll>
              <section>
                ...
                <p>Mind Hub s'engage à fournir des produits de qualité. Toutefois, les résultats obtenus grâce aux formations et outils dépendent de l'engagement et des actions de chaque utilisateur. Mind Hub ne garantit aucun résultat financier spécifique. Le site peut connaître des interruptions temporaires pour maintenance ou mise à jour.</p>
              </section>
            </AnimateOnScroll>
            ...
            <AnimateOnScroll>
              <section>
                ...
                <p>Pour toute question relative aux présentes CGV, vous pouvez nous contacter à l'adresse suivante : <a href="mailto:contact@mindhub.com" className="text-primary hover:underline">contact@mindhub.com</a></p>
              </section>
            </AnimateOnScroll>
          </div>
        </div>
