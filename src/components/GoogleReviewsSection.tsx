...
const reviews = [
  {
    name: "Issa Kharou",
    text: "Les formations sont très complètes et bien structurées. J'ai beaucoup appris en peu de temps.",
    avatar: "I",
  },
  {
    name: "Olive Larivière",
    text: "Excellente plateforme, le contenu est de qualité et le support est très réactif.",
    avatar: "O",
  },
  {
    name: "Fadi Nidé",
    text: "Je recommande vivement SavoirHub. Les prix sont imbattables pour la qualité proposée.",
    avatar: "F",
  },
];
      ...
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="grid md:grid-cols-[200px_1fr] gap-8 items-start mt-8 max-w-4xl mx-auto">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            {reviews.map((review) => (
              <div key={review.name} className="stat-card rounded-xl p-4 text-left space-y-3">
