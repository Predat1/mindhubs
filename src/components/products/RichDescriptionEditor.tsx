...
const RichTextBlock = ({ block, onChange }: { block: Extract<ProductContentBlock, { type: "richText" }>; onChange: BlockEditorProps["onChange"] }) => {
  ...
  const [color, setColor] = useState("#20252B");
  useEffect(() => {
