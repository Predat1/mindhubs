...
const videoTestimonials: VideoTestimonial[] = [
  {
    ...
    text: "Grâce à MindHubs, j'ai lancé mon agence SMMA et généré mes premiers 500 000 FCFA en seulement 2 mois !",
    rating: 5,
        ...
        <AnimateOnScroll>
          <div className="text-center mb-14 space-y-4">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-foreground">
              ...
              <span className="text-gradient-brand">MindHubs</span>
            </h2>
