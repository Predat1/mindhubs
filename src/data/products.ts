...
export const allProducts: Product[] = [
  ...
  { id: "fournisseurs", title: "200 Contacts De Fournisseurs Chinois Fiables", image: courseFournisseurs, oldPrice: "50.000 CFA", price: "5.000 CFA", category: "Business", tag: "business, e-book", description: "Vous recherchez des fournisseurs fiables pour acheter en Chine, en Turquie, à Dubaï et au Nigeria ?\n\nAvec ce pack, vous recevez 200 contacts de fournisseur testés et approuvés pour acheter ou importer des produits de qualité aux meilleurs prix et livrés rapidement. Évitez de perdre du temps et de l'argent à rechercher des fournisseurs ou de payer sans être livré.\n\nNotre liste de contact comprend des fournisseurs dans le domaine de la santé, du bien-être, de la beauté, de l'électronique, de l'électroménager, des accessoires de cuisine, du sport, des équipements de maison, des équipements de jardin, des jouets et divertissement pour enfants, de la bureautique et papeterie, de l'animalerie et bien d'autres.\n\nNotre liste est mensuellement mise à jour. Paiement unique et accès à vie.\n\nCliquez sur le bouton acheter pour commander et le recevoir automatiquement." },
