...
export const allProducts: Product[] = [
  ...
  {
    id: "pack-design-expert",
    title: "Pack Design Expert – 1000+ Templates Canva Pro",
    image: "/lovable-uploads/6d22d2d8-21f4-4e94-88f4-6e6914b301c1.png",
    oldPrice: "25.000 FCFA",
    price: "4.500 FCFA",
    category: "Design & Création",
    rating: 4.8,
    description: "**Transformez votre communication visuelle sans être designer.**\n\nCe pack contient tout ce dont vous avez besoin pour créer des visuels professionnels pour vos réseaux sociaux, vos publicités et votre marque.\n\n**Contenu du Pack :**\n- 500+ Templates Instagram & Facebook\n- 200+ Templates de Stories animées\n- 100+ Modèles de logos modifiables\n- Guide complet : Psychologie des couleurs & Typographie\n- Bonus : Liste des meilleurs sites de ressources gratuites",
    paymentLink: "https://nhvjjgbn.mychariow.shop/prd_design/checkout",
  },
  {
    id: "crypto-liberte",
    title: "Crypto Liberté – Le guide ultime pour investir en Afrique",
    image: "/lovable-uploads/6d22d2d8-21f4-4e94-88f4-6e6914b301c1.png",
    oldPrice: "40.000 FCFA",
    price: "10.000 FCFA",
    category: "Crypto & Finance",
    rating: 4.7,
    description: "**Maîtrisez la crypto-monnaie et protégez votre épargne contre l'inflation.**\n\nUn guide pas à pas conçu pour le contexte africain (Binance, P2P, Mobile Money).\n\n**Ce que vous allez apprendre :**\n- Comprendre la Blockchain simplement\n- Sécuriser ses premiers Bitcoins & Stablecoins\n- Stratégies d'investissement long terme\n- Éviter les arnaques et pyramides de Ponzi\n- Bonus : Accès au groupe Telegram privé",
    paymentLink: "https://nhvjjgbn.mychariow.shop/prd_crypto/checkout",
  },
  {
    id: "expert-immobilier",
    title: "Expert Immobilier – Kit Juridique & Stratégique",
    image: "/lovable-uploads/6d22d2d8-21f4-4e94-88f4-6e6914b301c1.png",
    oldPrice: "75.000 FCFA",
    price: "15.000 FCFA",
    category: "Immobilier",
    rating: 4.9,
    description: "**Investissez dans la pierre en toute sécurité.**\n\nTous les documents et conseils pour réussir vos transactions immobilières en Afrique de l'Ouest.\n\n**Inclus dans le kit :**\n- Modèles de contrats de bail & vente\n- Guide de vérification des titres fonciers\n- Stratégies de négociation avec les propriétaires\n- Checklist complète pour l'achat de terrain\n- Liste des zones à fort potentiel de croissance",
    paymentLink: "https://nhvjjgbn.mychariow.shop/prd_immo/checkout",
  },
  {
    id: "nutrition-africaine",
    title: "Nutrition & Vitalité – Le guide des super-aliments africains",
    image: "/lovable-uploads/6d22d2d8-21f4-4e94-88f4-6e6914b301c1.png",
    oldPrice: "20.000 FCFA",
    price: "3.500 FCFA",
    category: "Santé & Bien-être",
    rating: 4.6,
    description: "**Retrouvez votre énergie grâce aux trésors de notre terre.**\n\nDécouvrez comment utiliser le Moringa, le Baobab, le Karité et bien d'autres pour une santé de fer.\n\n**Au programme :**\n- 50 Recettes saines et locales\n- Programmes détox naturels\n- Secrets de longévité traditionnelle\n- Guide des compléments alimentaires naturels\n- Bonus : Plan de repas hebdomadaire",
    paymentLink: "https://nhvjjgbn.mychariow.shop/prd_sante/checkout",
  },
];
